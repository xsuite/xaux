...
curl \
  ...
  https://api.github.com/repos/xsuite/xaux/releases \
  -d '{"tag_name":"v'${new_ver}'","target_commitish":"main","name":"Xaux release '${new_ver}'","body":"","draft":true,"prerelease":false,"generate_release_notes":true}'
